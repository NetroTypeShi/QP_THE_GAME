...
public class comportamiento : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            winp = 0;
            pwinDefinitive.text = "P Won the game".ToString();
            pressSpace.text = "Press Space to restart".ToString();
            keyLock = true;
            stopGame();
        }
        // P gana el juego
        ...
        {
            winq = 0;
            qwinDefinitive.text = "Q Won the game".ToString();
            pressSpace.text = "Press Space to restart".ToString();
            keyLock = true;
            stopGame();
        }
